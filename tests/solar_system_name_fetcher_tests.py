...
class TestSolarSystemNameFetcher(Setup):
    ...
    def setUp(self):
        super().setUp()
        self.s00 = SolarSystemNameFetcherLocal(self.uk00)
        self.s60 = SolarSystemNameFetcherLocal(self.uk60)

    def test_get_names(self):
        self.assertEqual(self.s00.getNames(), {'category': 'solar_name', 'name': 'DO6H-Q'}, "Should return the right String")
        self.assertEqual(self.s60.getNames(), {'category': 'solar_name', 'name': ''}, "Should return an empty string")
    ...
    def test_fetch_name_with_id(self):
        self.assertEqual(self.s00.fetchNameWithId(), "DO6H-Q", "fetchNameWithId() Should return the correct List")
